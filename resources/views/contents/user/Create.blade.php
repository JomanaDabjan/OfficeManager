    ...
    <div class="card shadow mb-4" style="border: none; border-radius: 12px; overflow: hidden;">
        <div class="card-header py-4 text-white" style="background-color: #f96332; border: none;">
            <div class="d-flex align-items-center">
                <div class="icon-circle mr-3 text-center"
                    style="width: 45px; height: 45px; background: rgba(255,255,255,0.2); border-radius: 50%; display: flex; align-items: center; justify-content: center; font-size: 20px; font-weight: bold;">
                    +
                </div>
                <div>
                    <h4 class="m-0 font-weight-bold text-white">Add New User</h4>
                    <p class="mb-0 text-white-50" style="font-size: 14px;">Fill in the details below to create a new
                        user.</p>
                </div>
            </div>
        </div>
        ...
        <div class="card-body p-4">
            ...
            <form action="{{ route('admin.user.store') }}" method="POST" autocomplete="off">
                ...
                <div class="d-flex justify-content-end align-items-center mt-5 pt-3 border-top" style="gap: 10px;">
                    <a href="{{ route('admin.user.create') }}" class="btn btn-secondary px-4 py-2"
                        style="border-radius: 20px; font-weight: 600; background-color: #888888; border: none;">Cancel</a>
                    <button type="submit" class="btn btn-primary px-4 py-2"
                        style="border-radius: 20px; font-weight: 600; background-color: #f96332; border: none;">Save
                        User</button>
                </div>
            </form>

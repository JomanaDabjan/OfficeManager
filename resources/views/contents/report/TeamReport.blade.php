            ...
            <div class="card-body p-4">
                ...
                <div class="d-flex align-items-center justify-content-between">
                    ...
                    <div>
                        ...
                        <h3 class="card-title font-weight-bolder text-dark mb-0">
                            {{ \App\Models\Team::has('members')->count() }}
                        </h3>
            ...
            <div class="card-body p-4">
                ...
                <div class="d-flex align-items-center justify-content-between">
                    ...
                    <div>
                        ...
                        <h3 class="card-title font-weight-bolder text-dark mb-0">
                            {{ \App\Models\Team::doesntHave('members')->count() }}
                        </h3>
            ...
            <div class="card-body p-4">
                ...
                <div class="d-flex align-items-center justify-content-between">
                    ...
                    <div>
                        ...
                        <h3 class="card-title font-weight-bolder text-dark mb-0">
                            {{ \App\Models\Team::withCount('members')->get()->sum('members_count') }}
                        </h3>
            ...
            <div class="card-body p-4">
                ...
                <div class="d-flex align-items-center justify-content-between">
                    ...
                    <div>
                        ...
                        <h3 class="card-title font-weight-bolder text-dark mb-0">
                            {{ \App\Models\Team::whereNotNull('project_id')->count() }}
                        </h3>
            ...
            <div class="card-body p-4">
                ...
                <div class="d-flex align-items-center justify-content-between">
                    ...
                    <div>
                        ...
                        <h3 class="card-title font-weight-bolder text-dark mb-0">
                            {{ \App\Models\Team::whereNull('project_id')->count() }}
                        </h3>

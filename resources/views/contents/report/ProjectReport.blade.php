...
<div class="row mt-4 mb-4 align-items-center">
    <div class="col-lg-6 col-md-8 col-12 mb-3 mb-lg-0">
        ...
        <p class="text-muted text-sm mb-0">
            Comprehensive overview of all system projects, assigned managers, and task
            counts.
        </p>
    </div>
                    ...
                    <div class="d-flex flex-wrap align-items-center flex-grow-1" style="gap: 10px;">
                        ...
                        <div class="dropdown flex-fill">
                            ...
                            <div class="dropdown-menu shadow-lg border-0 py-2" aria-labelledby="dropdownTitle"
                                ...
                                <div id="titleList">
                                    ...
                                    @foreach($allTitles as $nameTitle)

                                    <a class="dropdown-item py-2 px-3 text-sm title-option {{ request('title') == $nameTitle ? 'active font-weight-bold text-primary' : '' }}"
                                        href="{{ route('admin.report.project-report', array_merge(request()->except(['title', 'page']), ['title' => $nameTitle])) }}"
                        ...
                        <div class="dropdown flex-fill">
                            ...
                            <div class="dropdown-menu shadow-lg border-0 py-2" aria-labelledby="dropdownStatus"
                                ...
                                <a class="dropdown-item py-2 px-3 text-sm {{ request('status') == 'overdue' ? 'active font-weight-bold text-primary' : '' }}"
                                    href="{{ route('admin.report.project-report', array_merge(request()->except(['status', 'page']), ['status' => 'overdue'])) }}">
                        ...
                        <div class="dropdown flex-fill">
                            ...
                            <button
                                ...
                                <span>
                                    {{ request('price') && request('price') != 'all' ? 'Price: ' . request('price') :
                                    'All Prices' }}
                                </span>
                            ...
                            <div class="dropdown-menu shadow-lg border-0 py-2" aria-labelledby="dropdownPrice"
                                ...
                                <a class="dropdown-item py-2 px-3 text-sm {{ !request('price') || request('price') == 'all' ? 'active font-weight-bold text-primary' : '' }}"
                                    href="{{ route('admin.report.project-report', array_merge(request()->except(['price', 'page']), ['price' => 'all'])) }}">
                                ...
                                <a class="dropdown-item py-2 px-3 text-sm {{ request('price') == 'low' ? 'active font-weight-bold text-primary' : '' }}"
                                    href="{{ route('admin.report.project-report', array_merge(request()->except(['price', 'page']), ['price' => 'low'])) }}">
                                ...
                                <a class="dropdown-item py-2 px-3 text-sm {{ request('price') == 'medium' ? 'active font-weight-bold text-primary' : '' }}"
                                    href="{{ route('admin.report.project-report', array_merge(request()->except(['price', 'page']), ['price' => 'medium'])) }}">
                                ...
                                <a class="dropdown-item py-2 px-3 text-sm {{ request('price') == 'high' ? 'active font-weight-bold text-primary' : '' }}"
                                    href="{{ route('admin.report.project-report', array_merge(request()->except(['price', 'page']), ['price' => 'high'])) }}">
...
<div class="row">
    ...
    <div class="col-md-12">
        ...
        <div class="card shadow-sm border-0" id="printable-report"
            style="border-radius: 16px; overflow: hidden; width: 100%; max-width: 100%;">

            <div class="card-body px-0 pb-0" style="width: 100%; max-width: 100%; overflow: hidden;">
                ...
                <div class="project-table-scroll-top" id="projectTableScrollTop">

                    <div class="project-table-scroll-top-inner" id="projectTableScrollTopInner">
                    </div>
                ...
                <div class="project-table-scroll" id="projectTableScroll">

                    <table class="table align-items-center table-flush mb-0" id="projectsTable"
                        style="width: 1600px; min-width: 1600px; max-width: none;">

                        <thead style="background: linear-gradient(135deg, #f96332 0%, #ff8c42 100%); color: white;">

                            <tr>

                                <th class="py-3 font-weight-bold text-white pl-4">
                                    Project Title
                                </th>

                                <th class="py-3 font-weight-bold text-white">
                                    Description
                                </th>
                                ...
                                <th class="py-3 font-weight-bold text-white text-center">
                                    Total Tasks
                                </th>
                                ...
                                <th class="py-3 font-weight-bold text-white text-right pr-4">
                                    Status
                                </th>
                            ...
                            <tr class="border-bottom project-row" data-status="{{ $projectStatus }}">
                                ...
                                <td class="text-right pr-4 align-middle" style="min-width: 150px;">
                                    ...
                                    <span class="badge badge-pill
                                        ...
                                        @elseif($projectStatus == 'overdue')
                                            badge-danger

                                        @elseif($projectStatus == 'due_today')
                                            badge-primary
                                        ...
                                        px-3 py-2 text-white shadow-sm" @if($projectStatus=='due_today' )
                                        style="background-color: #8f00ff !important;" @endif>
                ...
                <div class="project-table-scroll-bottom" id="projectTableScrollBottom">

                    <div style="height: 1px; min-width: 1600px;">
                    </div>

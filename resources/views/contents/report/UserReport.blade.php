...
@section('title', 'User Report Management')
        ...
        <div class="card border-0 h-100"
            ...
            <div class="card-body d-flex align-items-center justify-content-between"
                ...
                <div style="min-width: 0;">
                    ...
                    <div class="text-dark font-weight-normal" style="font-size: 30px; line-height: 1.2;">
                        {{ (clone $statsQuery)->where('role', 'employee')->count() }}
                    </div>
                </div>
        ...
        <div class="card border-0 h-100"
            ...
            <div class="card-body d-flex align-items-center justify-content-between"
                ...
                <div style="min-width: 0;">
                    ...
                    <div class="text-dark font-weight-normal" style="font-size: 30px; line-height: 1.2;">
                        {{ (clone $statsQuery)->where('role', 'Team_leader')->count() }}
                    </div>
                </div>
        ...
        <div class="card border-0 h-100"
            ...
            <div class="card-body d-flex align-items-center justify-content-between"
                ...
                <div style="min-width: 0;">
                    ...
                    <div class="text-dark font-weight-normal" style="font-size: 30px; line-height: 1.2;">
                        {{ (clone $statsQuery)->where('role', 'Manager')->count() }}
                    </div>
                </div>
        ...
        <div class="card shadow-sm border-0">
            <div class="card-body px-0 pb-0">
                ...
                <div class="table-responsive">
                    <table class="table table-bordered align-items-center table-flush mb-0" id="usersTable"
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td colspan="9" class="p-0 text-center align-middle"
                                    style="height: 240px; vertical-align: middle !important;">

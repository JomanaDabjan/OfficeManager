                    ...
                    <div class="modal-dialog modal-dialog-centered" role="document"> 
                        <div class="modal-content border-0 shadow-lg"> 
                            ...
                            <div class="modal-body p-4"> 
                                @if(isset($project->teams) && $project->teams->count() > 0) 
                                        ...
                                        <table class="table align-items-center table-flush mb-0 border" id="tasksTable" 
                                            ...
                                            <thead 
                                                ...
                                                <tr id="tableHeaders"> 
                                                    <th class="py-3 font-weight-bold text-white pl-4 draggable-header draggable-th text-center align-middle" 
                                                        ...
                                                        style="cursor: grab; font-size: 13px; border: 1px solid rgba(255,255,255,0.2) !important; width: 25%; white-space: nowrap;"> 
                                                    ...
                                                    <th class="py-3 font-weight-bold text-white pl-4 draggable-header draggable-th text-center align-middle" 
                                                        ...
                                                        style="cursor: grab; font-size: 13px; border: 1px solid rgba(255,255,255,0.2) !important; width: 15%; white-space: nowrap;"> 
                                                    ...
                                                    <th class="py-3 font-weight-bold text-white pl-4 draggable-header draggable-th text-center align-middle" 
                                                        ...
                                                        style="cursor: grab; font-size: 13px; border: 1px solid rgba(255,255,255,0.2) !important; width: 22%; white-space: nowrap;"> 
                                            ...
                                            <tbody id="tableBody"> 
                                                ...
                                                <tr class="border-bottom task-row"> 
                                                    <!-- Task Title Column (data-column="0") --> 
                                                    ...
                                                    <!-- Assigned Users Column (data-column="2") --> 
                                                    ...
                                                    <!-- Last Status Update Date Column (data-column="3") --> 
                                                    <td class="align-middle border-right text-center px-2" 
                                                        data-column="3" 
                                                        style="border: 1px solid #dee2e6 !important; font-size: 13px;"> 
                                                        <span class="text-muted" 
                                                            ...
                                                            {{ $task->updated_at?->format('Y-m-d H:i') ?? 'N/A' }} 
                                                        </span> 
                                                    </td> 
 
                                                    <!-- Actions Column (data-column="4") --> 
